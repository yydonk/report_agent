...
基于 AI 的实验报告自动生成系统。输入实验报告模板（Word）和实验文档照片，自动生成符合模板格式要求的完整实验报告，支持个性化配置报告文风以及段落长短。

## <mark>frame文件夹下有某学校某学院很完善的实验报告模板，可以拿来直接用，效果最好。如有个性化模板要求，尽量在提供的实验模板上改动，防止LLM识别失误</mark>
